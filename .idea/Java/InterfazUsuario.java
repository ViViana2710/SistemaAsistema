...
public class InterfazUsuario {
    ...
    private void registrarAsistencia(Usuario usuario) {
        ...
        System.out.print("Ingrese la hora de la clase: ");
        String hora = scanner.nextLine();

        System.out.print("¿Asistió o no asistió? (A/N): ");
        String estado = scanner.nextLine().toUpperCase();

        Asistencia asistencia = new Asistencia(materia, paralelo, hora, estado);

        manejadorAsistencia.registrarAsistencia(asistencia);
